<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="usersignup.aspx.cs" Inherits="Blood_Bank_management.usersignup" %>
            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                           <span class="badge badge-pill badge-info" style="background-color:rgb(0, 192, 226);">Login Credentials</span>
                        </center>
                     </div>
                  </div>
                  <div class="row">

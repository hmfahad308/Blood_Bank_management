    ...
    public partial class usersignup : System.Web.UI.Page
    {
        ...
        void signUpNewMember()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("INSERT INTO member_master_tbl(full_name,dob,blood_group,contact_no,email,area,city,pincode,full_address,member_id,password,account_status) values(@full_name,@dob,@blood_group,@contact_no,@email,@area,@city,@pincode,@full_address,@member_id,@password,@account_status)", con);
